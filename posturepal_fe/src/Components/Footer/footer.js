    ...
    <section className="py-10 bg-white sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          ...
          <div>
            <p className="text-sm pl-7 font-semibold tracking-widest !text-gray-400 uppercase">
              Company
            </p>
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex text-base text-black no-underline transition-all duration-200 hover:text-blue-600 focus:text-blue-600"
                >
                  {" "}
                  About{" "}
                </a>
          ...
          <div>
            <p className="text-sm font-semibold pl-7 tracking-widest !text-gray-400 uppercase">
              Help
            </p>
